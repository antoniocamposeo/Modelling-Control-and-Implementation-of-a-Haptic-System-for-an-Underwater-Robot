...
from rov_viewer.msg import Bar30, Attitude, State  # Custom data types


class BlueRov(Bridge):
    def __init__(self, device='udpin:192.168.2.1:14550', baudrate=115200):
        """
        Inherited from MAVBridge
        Args:
        ...
        for topic, subs in self.sub_topics.items():
            if len(subs) == 3:
                ...
                for name in arg:
                    ...
                    rospy.Subscriber(self.ROV_name + topicx, msg_type, callback, callback_args=topicx,
...
if __name__ == '__main__':
    ...
    bluerov = BlueRov(device='udpin:192.168.2.1:14550')
